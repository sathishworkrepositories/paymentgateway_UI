...
<a href="{{ $reset_url }}" class="button button-primary" target="_blank" style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; border-radius: 3px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); color: #fff; display: inline-block; text-decoration: none; -webkit-text-size-adjust: none; background-color: #0c4cdd; border-top: 10px solid #0c4cdd; border-right: 18px solid #0c4cdd; border-bottom: 10px solid #0c4cdd; border-left: 18px solid #0c4cdd;">Reset Password</a>
</td>
</tr>
</table>
</td>
