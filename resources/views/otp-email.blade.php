				...
				<div class="loginouterbox">
					<div class="login-form">
						...
						<div class="succes-icon">
							<img src="{{ url('/img/profile-Image.png') }}" alt="" class="otp">
						</div>
						<h4 class="heading-title">Welcome back! {{ Auth::user()->name }}</h4>
						...
						<div class="formcontentbox">
							<div class="mlmwizardform">
								...
								@endif
								<form id="ms-login-form" class="siteformbg" action="{{ route('verifyemailotp') }}" method="POST" autocomplete="off">
									{{ csrf_field() }}   
									<div class="form-card">
