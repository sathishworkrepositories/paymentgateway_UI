...
@if (session('profilestatus'))
    	<div class="snackbar show" role="alert"><i class="fa fa-check-circle text-success"></i> {{ session('profilestatus') }}</div>
		@endif
<div class="profile-card">
    ...
    <div class="row">
		...
		<div class="col-lg-12 col-xl-7 col-md-12 col-sm-12 col-xs-12">        	
        	<form action="{{ route('userprofile') }}" autocomplete="off" method="POST" id="formtarget" enctype='multipart/form-data'>
			{{ csrf_field() }}
        ...
        <div class="col-lg-12 col-xl-7 col-md-12 col-sm-12 col-xs-12">        	
            ...
            <div class="profile-list">
                <div class="form-group">  
					...
					<span class="help-block">
					<strong class="text text-danger">{{ $errors->first('business_name') }}</strong>
					</span>
					@endif
                </div>
                ...
                <div class="form-group">  
                    ...
                    <input class="form-control" type="text" name="company_website" value="{{ $user->company_website }}" required >
                    @if ($errors->has('company_website'))
					<span class="help-block">
					<strong class="text text-danger">{{ $errors->first('company_website') }}</strong>
					</span>
					@endif
                </div>
            </div>
        ...
        <div class="col-lg-12 col-xl-5 col-md-12 col-sm-12 col-xs-12">
			...
			<div class="change-password">
				...
				<div class="alert alert-success alert-dismissible" role="alert"><strong>Success!</strong> {{ session('success_pwd') }}
				</div>
				@endif

				@if (session('error'))
				<div class="alert alert-danger alert-dismissible" role="alert"><strong>Failed!</strong> {{ session('error') }}
				</div>
				@endif
            <fieldset>
                <div class="form-card">
                    <div class="form-group ">
                        <label>Current Password<span class="text text-danger">*</span></label>
                        <input type="text" class="form-control" name="oldpassword" class="form-control" id="oldpassword" value="" required>
                        @if ($errors->has('oldpassword'))
						<span class="text-danger errors-text show_error_email">{{ $errors->first('oldpassword') }}
						</span>
						@endif
                    </div>
                ...
                <div class="form-card">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            <input type="password" class="form-control" name="newpassword"  class="form-control" value="" id="password" required>

                            <span class="input-group-text" id="passtexticon"  style="cursor: pointer;" onClick="getPasswordResponse()"><i class="fa fa-eye-slash"></i> </span>
                        </div>
                    </div>
                    @if ($errors->has('newpassword'))
					<span class="text-danger errors-text show_error_password">{{ $errors->first('newpassword') }}</span>
					@endif
                </div>
            </fieldset>
            ...
            <fieldset>
                <div class="form-card">
                    <div id="show_failed_login_password"></div>
                    <div class="form-group ">
                        <label>Confirm New Password <span class="texts text-danger">*</span></label>
                        <div class="input-group">
                            <input type="password" name="confirmnewpassword" autocomplete="current-password" required="" id="id_password" class="form-control">
						...
						<span class="text-danger errors-text show_error_password">{{ $errors->first('confirmnewpassword') }}</span>
						@endif
                    </div>
                </div>
                <div class="withdraw-submit-btn submit-btn">
