						...
						<div class="container">
							<div class="col-md-12 col-sm-12 col-xs-12 center-content securitybox">					
								<div class="form-container">
									<form action='{{ url("/button-maker-submit") }}' method='POST' enctype='multipart/form-data' id="profileForm">
										{{ csrf_field() }}
              ...
              <tr>
                ...
                <td style="text-align:center">Yes</td>
													...
													<tr>
														<td>Shipping Cost</td>
														<td>
															<input name="shippingf" class="form-control" value="0.00000000">
														</td>
														<td class="text-center">No</td>
													</tr>
													<tr>
