@php $title = "Merchant Tool Simple"; $atitle ="merchant";
@endphp
						...
						<div class="table-responsive" data-simplebar>
							<table class="table table-small-font no-mb table-borderded">
								...
								<tbody>
									...
									<tr>
										<td>cmd</td>
										<td>This should always be set to '_pay_simple'.</td>
										<td>Yes</td>
										<td>N/A</td>
									</tr>
									<tr>
									...
									<tr>
										<td>currency</td>
										<td>The currency of the payment (BTC, LTC, USD, EUR, etc.).
									...
									<tr>
										...
										<td>Currency codes separated with a comma of coins you will accept. This is used to further restrict the coin selection from your list of enabled coins; for example if you are doing your own exchange rates and want to limit checkout to a user selected currency.
										Example: BTC,LTC</td>
										<td>No</td>
										<td>255</td>
									</tr>
									...
									<tr>
										<td>shippingf</td>
										<td>Cost of shipping the item.</td>
										<td>No</td>
										<td>N/A</td>
									</tr>
									<tr>
										<td>taxf</td>
										<td>Any tax to charge.</td>
										<td>No</td>
										<td>N/A</td>
									</tr>
									<tr>
										<td>allow_ship_countries</td>
										<td >ISO 3166 2 digit country codes separated with a comma of countries you will ship to. The will deny transactions if the shipping address is not in one of these countries.
										<br>Example: US,CA,GB</td>
										<td>No</td>
										<td>255</td>
									</tr>
									<tr>
