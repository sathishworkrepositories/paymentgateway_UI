	...
	<section class="loginbg inner-banner-ht buttonmaker">
		<div class="container apicointainer">
			<div class="col-md-12 col-sm-12 col-xs-12 center-content securitybox">
				<!-- <h3 class="text-center fnt-bld inner-heading">Hashcodex API</h3> -->			
				<div class="form-container">
					<div class="examplecodebg codetextbg apieditortext">
						<div class="apibanner">				
						<div class="row apiflexbox">					
							<div class="col-md-3 col-sm-4 col-xs-12 apiciontenttext">								
								...
								@php
								$subcategory =App\Models\Subapicategory::where('cat_id',$val->id)->get();
								@endphp
								<ul class="listsetup">
									@foreach($subcategory as $val1)
									<li><a href="{{ url('view/'.\Crypt::encrypt($val->id).'/'.\Crypt::encrypt($val1->id)) }}">{{ $val1->sub_title }}</a></li>
									@endforeach
								</ul>	
								@endforeach		
							</div>
							<div class="col-md-9 col-sm-8 col-xs-12 apicontentf">
								<h4 class="subt-t fnt-reg">
									@if(isset($Subapicategory->sub_title))
									{{ $Subapicategory->sub_title }}
									@endif
								</h4>
								<div class="content">
									@if(isset($Subapicategory->desc))
									{!! $Subapicategory->desc !!}
									@endif
								</div>								
							</div>
