@php $title = "Example Buttons"; $atitle ="merchant";
@endphp
					...
					<div class="examplecodebg">
						...
						<textarea rows="18" class="form-control">
							<form action="{{ url('/makepayment') }}" method="post">
								...
								<input type="hidden" name="merchant" value="xxxxxxxxxxxx">
								...
								<input type="image" src="{{ url('img/paymentlogo.svg') }}" alt="Donate with Hashcodex">
							</form>
						</textarea>
