@php $title = "AdvanceMerchantToolsSimple"; $atitle ="merchant";
@endphp
        ...
        <div class="col-lg-10 col-xl-10 col-md-12 col-sm-12 col-xs-12">
               ...
               <div class="header-part-outer">
                ...
                <div class="head-title-part">
                  <h1>Advance  HTML POST Fields</h1>
		...
		<div class="container">
			<div class="col-md-12 col-sm-12 col-xs-12 center-content securitybox">
				...
				<div class="form-container">
					...
					<h4 class="subt text-center pb-30">If you need a checkout with more options such as buyer selectable quantity, multiple item shipping, etc. check out our <a href="{{ route('advancebuttonmaker') }}" class="alinktext">Advanced Button</a>.</h4>	
            ...
            <tbody>
              ...
              <tr>
                <td>cmd</td>
                <td>This should always be set to '_pay_advanced'.</td>
                <td>Yes</td>
                <td>N/A</td>
              </tr>
              <tr>
              ...
              <tr>
                <td>quantity</td>
                <td>Lets you set a quantity of items. The purchase price will be quantity * amount from above. <br>Note: Must be 1 or higher, decimals are not supported.</td>
                <td>No</td>
                <td>N/A</td>
              </tr>
              <tr>
              ...
              <tfoot>
                <tr>
                  <td colspan="4" class="text-center">Feel free to check out our <a href="{{ route('advanceexamplebuttons') }}" class="alinktext">example buttons</a>.</td>
                </tr>
              </tfoot>
            </table>
						</div>
